...
nnoremap <silent> <localleader> :silent <c-u> :silent WhichKey '<Space>'<CR>
vnoremap <silent> <localleader> :silent <c-u> :silent WhichKeyVisual '<Space>'<CR>
"nnoremap <silent> <localleader>m :<c-u>WhichKey  ','<CR>
"vnoremap <silent> <localleader>m :<c-u>WhichKeyVisual  ','<CR>
...
"let g:which_key_map['h'] = [ '<C-W>s'                             , 'splitbelow']
...
"let g:which_key_map['j'] = [ ':wincmd j'                               , 'window below' ]
"let g:which_key_map['k'] = [ ':wincmd k'                               , 'window up' ]
